...
class _JoinScreenState extends ConsumerState<JoinScreen> {
  ...
  Future<void> _join() async {
    ...
    // Generate email from name (using domain for demo)
    final email = '${_name.text.toLowerCase().replaceAll(' ', '.')}@favorly.local';
    final password = 'demo_password_123';
    ...
    if (authState.error != null) {
      setState(() => _error = authState.error ?? 'Signup failed');
    }
  }
