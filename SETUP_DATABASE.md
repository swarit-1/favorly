...
2. Enable:
   - ✅ **Email** (toggle on)
   - ✅ **Anonymous** (toggle on - for testing)

## Step 3: Disable RLS (for demo only!)

1. Left sidebar → **Authentication** → **Policies**
2. For each table, click it and **Disable RLS**

⚠️ **Note:** This is DEMO only. Enable RLS in production!

## Step 4: Enable Realtime

1. Left sidebar → **Realtime** → **Replication**
...
✅ Should create account and show trips screen!
...
- Schema not created yet → Run Step 1
- RLS blocking signup → Disable RLS in Step 3

**"Invalid invite code"**
- Demo data not seeded → Run Step 5
- Circle not created → Check Supabase: `SELECT * FROM circles;`
...
Done? You should now be able to sign up! 🚀
